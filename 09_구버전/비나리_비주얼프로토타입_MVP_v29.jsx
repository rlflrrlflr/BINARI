...
function GuardianCanvas({ saju, zo, mbti, num, moon, birth, agitateRef, reactRef, restRef, size = 340 }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      if (restRef && restRef.current && !agi && !reacting && nowMs - lastHeavy < 46) { raf = requestAnimationFrame(draw); return; } // v29: 정독/대기 중 ~21fps로 솎아 스크롤·카드 렌더에 양보
      lastHeavy = nowMs;
      t += 0.01 * speed;
...
export default function App() {
  ...
  useEffect(() => { restRef.current = busy || !!res; }, [busy, res]); // v29: 대기·정독 중엔 캔버스 프레임 솎기
