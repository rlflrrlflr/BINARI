...
ck("요일 — 2026-08-06 은 목요일", WEEK_KO[weekday(2026, 8, 6)] === "목", WEEK_KO[weekday(2026, 8, 6)]);
...
/* ── 아칸 ── */
ck("아칸 — 목요일생 남자는 Yaw", akan(2026, 8, 6, true).name === "Yaw", akan(2026, 8, 6, true).name);
...
/* ── 태국 ── */
ck("태국 — 목요일은 주황·목성", thaiDay(2026, 8, 6).color === "주황색" && thaiDay(2026, 8, 6).planet === "목성");
ck("태국 — 월요일은 노랑(왕실색)", thaiDay(2026, 8, 10).day === "월" && thaiDay(2026, 8, 10).color === "노란색");
...
const wa = weton(2026, 8, 6), wb = weton(2026, 8, 11), wc = weton(2026, 9, 10);
...
ck("웨톤 — 넵투는 7~18 범위", [...Array(400)].every((_, i) => { const n = weton(2026, 1, 1 + i % 300).neptu; return n >= 7 && n <= 18; }));
