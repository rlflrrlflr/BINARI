...
export const FACE_PRESETS = {
  ...
  /* ⚠ 2026-08-30 로 **전부 0.8 배** 했다(얼굴 영역 20% 축소). RAD 도 같이 줄였다.
  ...
  a: { name: "A · 아주 작은 점 (22.9만형)", eyeSz: 0.012, gap: 0.104, cy: 0.500, blush: true,
       mouth: "smile", mSz: 0.040, mCy: 0.548 },
  b: { name: "B · 작은 점 (8.8만형)",        eyeSz: 0.012, gap: 0.104, cy: 0.500, blush: true,
       mouth: "wave",  mSz: 0.048, mCy: 0.548 },
  c: { name: "C · 굳은 눈 (5.8만형)",        eyeSz: 0.012, gap: 0.104, cy: 0.500, blush: false,
       mouth: "flat",  mSz: 0.045, mCy: 0.548 },
  d: { name: "D · 반짝임 (3.8만형)",         eyeSz: 0.012, gap: 0.104, cy: 0.500, blush: true,
       mouth: "squig", mSz: 0.042, mCy: 0.548 },
...
export function drawFace(x, S, opt) {
  ...
  const eu = Math.asin(Math.min(0.95, P.gapR != null ? P.gapR : (S * P.gap) / RAD));
