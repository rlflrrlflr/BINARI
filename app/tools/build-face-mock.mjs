...
<div class="wrap">
  ...
  <h2>실물을 보고 — 관찰 다섯</h2>
  <p class="lead">창업자가 보낸 캡처 5건(yurang 5.8만 · wadadabear 8.8만 · young_forest · free.hada · milletoon)을
  보고 적는다. <b>수치는 육안 추정</b>이다 — 픽셀로 재지 않았다.</p>
  <table class="num"><tbody>
    <tr><td>① 흰자</td><td><b>다섯 중 넷이 없다.</b> 까만 점이 주류 · 흰자는 free.hada 하나</td></tr>
    <tr><td>② 눈 크기</td><td>얼굴 폭의 <b>5~10%</b> <i>(우리 15% — 두 배 크다)</i></td></tr>
    <tr><td>③ 눈 간격</td><td>얼굴 폭의 <b>40~50%</b> <i>(우리 27% — 훨씬 좁다)</i></td></tr>
    <tr><td>④ 눈썹</td><td><b>표정의 절반을 한다.</b> 다섯 중 셋이 쓴다 <i>(우리 보드엔 아예 없었다)</i></td></tr>
    <tr><td>⑤ 눈 높이</td><td>얼굴의 <b>55~65%</b> — 아래쪽 <i>(우리 45.5% — 높다)</i></td></tr>
  </tbody></table>
  <p class="warn" style="margin-top:14px">⚠ <b>캘시퍼와 인스타툰은 다른 계열이다.</b> 캘시퍼는 흰자가 핵심이고,
  인스타툰 주류는 까만 점 + 눈썹이다. 어느 쪽으로 갈지가 첫 갈림길이다.</p>
...
[[0.052,"작게 11%"],[0.062,"13%"],[0.072,"지금 15%"],[0.086,"18%"],[0.100,"크게 21%"]]
