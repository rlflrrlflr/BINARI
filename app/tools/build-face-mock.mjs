...
<div class="wrap">
  ...
  배경 원은 <b>몸의 코어</b>다 — 눈이 그 안에 있는지 같이 본다.</p>
  <p class="lead">지금 값: 눈 <b>0.088</b> · 간격 <b>0.39</b>(오행 폭으로 나눈 뒤) · 입 0.30 / 0.36</p>
  ...
  <table class="num"><tbody>
    ...
    <tr><td>눈 크기 <i>(eyeSz)</i></td><td>구 반지름의 <b>0.088</b></td></tr>
    <tr><td>두 눈 간격 <i>(gapR)</i></td><td>구의 <b>0.42 자리</b> ÷ 오행 가로폭 <i>(화 1.26 · 목 1.18 · 금 1.08 · 토 0.98 · 수 0.94)</i></td></tr>
...
const APP = { radFrac: 0.136, gapR: 0.389, eyeSz: 0.088, mSz: 0.30, mouthR: 0.36, cy: 0.50 };
function appCell(parent, over, label, on){
  ...
  x.strokeStyle="rgba(150,120,60,.30)"; x.setLineDash([4,4]); x.lineWidth=1;
  x.beginPath(); x.arc(S/2,S*o.cy,R0,0,7); x.stroke(); x.setLineDash([]);
  drawFace(x,S,o); x.restore();
  d.insertAdjacentHTML("beforeend",'<p class="nm">'+label+'</p>');
  parent.appendChild(d);
}
[[0.055,"0.055"],[0.070,"0.070"],[0.088,"지금 0.088"],[0.110,"0.110"],[0.135,"0.135"],[0.165,"0.165"]]
  .forEach(([v,l])=>appCell(vSize,{eyeSz:v},l,v===0.088));
[[0.24,"0.24"],[0.32,"0.32"],[0.389,"지금 0.39"],[0.46,"0.46"],[0.56,"0.56"],[0.68,"0.68"]]
  .forEach(([v,l])=>appCell(vGap,{gapR:v},l,Math.abs(v-0.389)<1e-6));
