...
<div class="wrap">
  ...
  <p class="lead">지금 값: 눈 <b>0.155</b> · 간격 <b>0.64</b>(오행 폭으로 나눈 뒤) · 입 0.30 / 0.36</p>
  ...
  <table class="num"><tbody>
    ...
    <tr><td>두 눈 간격 <i>(gapR)</i></td><td>구의 <b>0.691 자리</b> ÷ 오행 가로폭 <i>(금에서 0.64)</i> <i>(화 1.26 · 목 1.18 · 금 1.08 · 토 0.98 · 수 0.94)</i></td></tr>
...
const APP = { radFrac: 0.136, gapR: 0.64, eyeSz: 0.155, mSz: 0.30, mouthR: 0.36, cy: 0.50 };
...
[[0.36,"0.36"],[0.46,"0.46"],[0.56,"0.56"],[0.64,"지금 0.64"],[0.74,"0.74"],[0.84,"0.84"]]
  .forEach(([v,l])=>appCell(vGap,{gapR:v},l,Math.abs(v-0.64)<1e-6));
